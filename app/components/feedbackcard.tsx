...
const Testimonials = [
  {
    ...
    feedback:
      "Glad that you, too, understand the importance of proof of work. Thank you so much. Means a lot for the Fueler community ❤️✨",
  ...
  },
  {
    ...
    feedback:
      "Lazy loading and code splitting in Next.js are game changers for optimizing performance and improving user experience.",
    source: "Feedback on Blog",
  ...
  },
  {
    ...
    feedback:
      "I read your post. The explanation is easier to understand and on point.",
  ...
  },
  {
    ...
    feedback:
      "Recently thought of making an extension and found your blog on it...",
  ...
  },
  {
    ...
    feedback:
      "Profile looking super clean! Nice profile tags you added there and nice to see the people in your Circle.",
  ...
  },
  {
    ...
    source: "Supabase",
    link: "https://x.com/Shivamkatare_27/status/1675055421659262977",
  ...
  },
  {
    ...
    feedback:
      "Hi, Thanks for writing your blog regarding React QR code generator, it was helpful and I wanted to let you know.",
  ...
  },
  {
    ...
    secondaryFeedback:
      "Is it open source, I actually wanted to learn to make this kind of things",
    source: "Feedback on Project",
    link: "https://re-card.vercel.app/",
    tooltipTitle: "Take me to that Project",
  },
